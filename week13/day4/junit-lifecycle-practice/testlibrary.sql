-- Create the testlibrary schema
CREATE SCHEMA IF NOT EXISTS testlibrary;

-- Create the author table
CREATE TABLE IF NOT EXISTS testlibrary.author (
...
CREATE TABLE IF NOT EXISTS testlibrary.genre (
    genre_id INT AUTO_INCREMENT PRIMARY KEY,
    genre_name VARCHAR(50) NOT NULL
);

-- Create the book table
CREATE TABLE IF NOT EXISTS testlibrary.book (
    ...
    isbn VARCHAR(20),
    genre_id INT,
    FOREIGN KEY (author_id) REFERENCES testlibrary.author(author_id),
    FOREIGN KEY (genre_id) REFERENCES testlibrary.genre(genre_id)
);

-- Insert statements for genres
INSERT INTO testlibrary.genre (genre_name) VALUES
    ('Fiction'),
    ('Non-fiction'),
    ('Mystery'),
    ('Thriller'),
...
INSERT INTO testlibrary.author (author_name, birth_year, nationality) VALUES
...
INSERT INTO testlibrary.book (title, author_id, publication_year, isbn, genre_id) VALUES
