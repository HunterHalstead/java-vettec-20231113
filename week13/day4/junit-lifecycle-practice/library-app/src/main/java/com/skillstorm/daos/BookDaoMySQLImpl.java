...
public class BookDaoMySQLImpl implements BookDao {
	...
	// REFACTOR TO ALLOW PASSING IN A CONN OBJECT
	// dependency injection - this class relies on a conn object
	// pass this in when the BookDaoMySQLImpl class is used
	// so the test class can pass in a test-db connection instead
	public BookDaoMySQLImpl(Config config) {
		this.config = config;
	}
    ...
    public List<Book> findAll() {
        //			DbUtils config = DbUtils.getInstance(); // Not testable! 
